(function () {
  ...
  function withAssetVersion(url) {
    var config = window.LUOWEI_SITE_CONFIG || {};
    var version = config.assetVersion ? String(config.assetVersion) : '';
  ...
  function fetchIndex() {
    if (!searchIndexPromise) {
      ...
      searchIndexPromise = codec
        .fetchMessagePackGzip(withAssetVersion('/assets/site/search-index-v1.msgpack.gz'))
